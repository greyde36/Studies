...
print(5<10)                                        #- 5 меньше 10?
print(5<=10)                                       #- 5 меньше или равно 10?
print(5>=10)                                       #- 5 больше или равно 10?
print(5==10)                                       #- 5 равно 10?
print(5!=10)                                       #- 5 не равно 10?
...
print(int('5')+5)                                  # присвоить строке статус числа, также работает наоборот
                             #<-- комментарий
name = "test12345"                                 # Подсчёт символов в строке каждый по отдельности
