...
# этот результат вместе с третьим элементом подставляет в функцию, получает результат
# этот результат вместе с 4м элементом подставляет в функцию, получает результат
# и т.д.
#  1 + 2 -> 3
#  3 + 3 -> 6
#  6 + 4 -> 10
