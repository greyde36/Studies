...
# Это так называемое "замыкание" - объект функции хранит у себя все
# _необходимые_ему_ переменные в области видимости, точнее ссылки на них.
...
# Старайтесь как можно меньше использовать изменяемые объекты внутри функций-на-лету,
# как и глобальные переменные - это приводит к неожиданным последствиям :(
# Замыкать объекты, созданные в области видимости окружающей функции можно.
...
###
# Еще один способ сделать функции на лету - создание объекта, который можно вызывать
class Multiplier:
