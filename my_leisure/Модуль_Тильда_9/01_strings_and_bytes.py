...
# то есть каждый символ имеет свой код. В pythone символы хранятся в кодах unicode
# http://foxtools.ru/Unicode
# Эта таблица стандарт для ВСЕХ символ, которое придумало человечество

# Это именно стандарт, а не кодировка — сам по себе Юникод не определяет,
# как символы будут сохраниться на жестком диске или передаваться по сети.
