...
import time
time.gmtime(5)  # вернет тюпл со временем https://docs.python.org/3/library/time.html#time.struct_time

# Сформировать правильный путь к файлу с учетом особенностей ОС.
...
# это самые основные, остальные см https://goo.gl/AB6aDQ
